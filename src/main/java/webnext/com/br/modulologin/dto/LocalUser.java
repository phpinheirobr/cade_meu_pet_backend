package webnext.com.br.modulologin.dto;import java.util.Collection;
...
public class LocalUser extends User implements OAuth2User, OidcUser {
	...
	private  webnext.com.br.modulologin.model.User user;
	...
	public LocalUser(final String userID, 
			...
			final webnext.com.br.modulologin.model.User user) {
	...
	public static LocalUser create(webnext.com.br.modulologin.model.User user,
	...
	public webnext.com.br.modulologin.model.User getUser() {
		return user;
	}
}
