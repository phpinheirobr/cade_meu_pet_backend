package br.com.webnext.modulologin.dto;import java.util.Collection;
...
public class LocalUser extends User implements OAuth2User, OidcUser {
	...
	private  br.com.webnext.modulologin.model.User user;
	...
	public LocalUser(final String userID, 
			...
			final br.com.webnext.modulologin.model.User user) {
	...
	public static LocalUser create(br.com.webnext.modulologin.model.User user,
	...
	public br.com.webnext.modulologin.model.User getUser() {
		return user;
	}
}
